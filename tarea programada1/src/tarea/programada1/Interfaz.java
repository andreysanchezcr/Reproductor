...
public class Interfaz extends JFrame// implements ActionListener// implements java.awt.ActionListener
{
	...
	public void filtros(){
        ...
        try { 
            miReproductor.control.open(archivo.getSelectedFile());//Le decimos al control del player que abra el archivo 
		...
		public void  actionPerformed(ActionEvent event){
			...
			if(event.getSource()==BtnPlay){
				...
				System.out.println("Estas dentro del boton 1");
                                ...
                                File archivo =new File("C:\\Users\\ricardo\\Desktop\\wigle.mp3");
                                
                            try {
                                miReproductor.control.open(archivo);
                            } catch (BasicPlayerException ex) {
                            ...
                            try {
                                ...
                                Logger.getLogger(Interfaz.class.getName()).log(Level.SEVERE, null, ex);
                                            ...
                                            //Toma el texto escrito en el botón y lo examina en dos casos
             
                if (true) {         BtnPlay.setText("Pausa");
                enReproduccion = true; 
                } 
                 if (enReproduccion) { 
            try { 
